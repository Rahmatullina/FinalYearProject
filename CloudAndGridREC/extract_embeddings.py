...
def extract_embeddings(pathDetector='CloudAndGridREC/face_detection_model',
					   pathEmbModel='CloudAndGridREC/openface_nn4.small2.v1.t7',
					   pathDataset='CloudAndGridREC/dataset',
					   pathEmbeddings='CloudAndGridREC/output/embeddings.pickle',
					   conf=0.5):
	...
	imagePaths = list(paths.list_images(pathDataset))
